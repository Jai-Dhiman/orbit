...
export default function HomeScreen() {
  ...
  const handleSend = () => {
    console.log('Send:', value, 'with model', selectedModel);
    setValue('');
  };
        ...
        <View style={styles.badgeContainer}>
          <View style={styles.badge}>
            <Text style={styles.badgeCount}>
              {dummyFeed.filter((i) => i.type === 'note').length}
            </Text>
            <Text style={styles.badgeLabel}>Notes</Text>
          </View>
          <View style={styles.badge}>
            <Text style={styles.badgeCount}>
              {dummyFeed.filter((i) => i.type === 'task').length}
            </Text>
            <Text style={styles.badgeLabel}>Tasks</Text>
          </View>
          <View style={styles.badge}>
            <Text style={styles.badgeCount}>
              {dummyFeed.filter((i) => i.type === 'event').length}
            </Text>
